package com.signaturemaker.app.ui.snackbar
...
class SnackbarController(
    ...
    fun showSuccess(message: String, actionLabel: String? = null) {
        showMessage(SnackbarMessage.Success(message, actionLabel))
    }
    ...
    fun showError(message: String, actionLabel: String? = null, onAction: (() -> Unit)? = null) {
        showMessage(SnackbarMessage.Error(message, actionLabel), onAction)
    }
    ...
    fun showInfo(message: String, actionLabel: String? = null) {
        showMessage(SnackbarMessage.Info(message, actionLabel))
    }
    ...
    fun showWarning(message: String, actionLabel: String? = null) {
        showMessage(SnackbarMessage.Warning(message, actionLabel))
    }
}
